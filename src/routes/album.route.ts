...
albumRoutes.put('/:id',  RoutesDataValidator.paramsValidator(idSchemaValidate),  RoutesDataValidator.bodyValidator(albumUpdateSchemaValidate), albumController.update.bind(albumController))
